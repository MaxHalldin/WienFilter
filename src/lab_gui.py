...
from pythion.connections import PortSelector, RS3000Output, LinearCalibration, PicoOutput, RBDInput
...
with magnet_component, velocity_filter_component, input_component:
    win.run()
